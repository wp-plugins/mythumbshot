...
function mythumbshot_js() {
	echo '<script type="text/javascript">var bubbleImagePath="'.get_bloginfo('wpurl').'/wp-content/plugins/wp-mythumbshot/bg.png"</script>';
	echo "\n";
	echo '<script src="'.get_bloginfo('wpurl').'/wp-content/plugins/wp-mythumbshot/previewbubble.js" type="text/javascript"></script>';
	echo "\n";
}
